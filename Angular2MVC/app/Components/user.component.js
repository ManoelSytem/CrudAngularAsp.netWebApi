...
var UserComponent = (function () {
    ...
    UserComponent.prototype.ngOnInit = function () {
        this.userFrm = this.fb.group({
            ...
            DataNascimento: ['dd/MM/yyyy', forms_1.Validators.required],
            SaldoConta: ['1234567890.', forms_1.Validators.required]
        });
        this.LoadUsers();
    };
    ...
    UserComponent.prototype.addUser = function () {
        ...
        this.modalTitle = "Cadastrar Nova Pessoa";
    ...
    UserComponent.prototype.deleteUser = function (id) {
        ...
        this.modalTitle = "Confirma  a deleção?";
        ...
        switch (this.dbops) {
            case enum_1.DBOperation.create:
                this._userService.post(global_1.Global.BASE_USER_ENDPOINT, formData._value).subscribe(function (data) {
                    if (data == 1) {
                        _this.msg = "Dados Cadastrado com Sucesso!";
                        _this.LoadUsers();
                    }
                    else {
                        _this.msg = "Há algum problema na gravação de registros, entre em contato com o administrador do sistema!";
                    }
                    _this.modal.dismiss();
                }, function (error) {
                    _this.msg = error;
            ...
            case enum_1.DBOperation.update:
                this._userService.put(global_1.Global.BASE_USER_ENDPOINT, formData._value.Id, formData._value).subscribe(function (data) {
                    if (data == 1) {
                        _this.msg = "Dados Atualizado com Sucesso!";
                        _this.LoadUsers();
                    }
                    else {
                        _this.msg = "Há algum problema na gravação de registros, entre em contato com o administrador do sistema";
            ...
            case enum_1.DBOperation.delete:
                this._userService.delete(global_1.Global.BASE_USER_ENDPOINT, formData._value.Id).subscribe(function (data) {
                    if (data == 1) {
                        _this.msg = "Dados Excluido com Sucesso!";
                        _this.LoadUsers();
                    }
                    else {
                        _this.msg = "Há algum problema na gravação de registros, entre em contato com o administrador do sistema";
